...
urlpatterns = [
    ...
    path('vote/answer/<int:answerId>/',
     ...
     #     ========== Item Comment ==========
    path('comment/create/item/<slug:slug>/',
         comment_views.commentCreateItem, name='comment_create_item'),
    path('comment/modify/item/<int:commentId>/',
         comment_views.commentModifyItem, name='comment_modify_item'),
    path('comment/delete/item/<int:commentId>/',
         comment_views.commentDeleteItem, name='comment_delete_item'),          
]
